...
>_"Welcome to BlaBla Corp! The social media company that’s all about community._
>
>_Your design project is to develop a new “community hub” site where members with a common interest can come together and connect. These hubs are tailor made so that groups can communicate >what’s important to them. It is this effortless sharing that our brand is known for, and this is why we need designers like you. We need you to explore and understand what is important to a >community and to build these community hubs."_

This is the main context of our design solution: the brief is asking for a solution that is user-specific, dynamic and able to be tailored for different groups of people based on a common interest.



>_"Community hubs form points of connection across the BlaBla Corp. Social media network. This means that a user of BlaBla Corp, colloquially termed a blabber, can use their one log-in across >multiple community hubs. Note that this means you do not need a signup page for any prototype as this is handled as a core part of the BlaBla Corp web presence (see expectations on user >profiles below)."_

The design solution must be able to seamlessly remember and handle a user across multiple hubs. (ADD MORE PLEASE)

>_"The core of any community hub is the information which members share on the platform and the experience they share. Choosing the right information shapes the community to thrive as the >members feel connected. Curating the right experience is what keeps them coming back. It also makes for a more valuable market section in which we can sell advertising space. Therefore, >information and experience are the core of both our business and our blabber's experience."_
